...
def character_create():
    ...
    try:
        ...
        delay.print_delay(f"Please enter your fighter's {style.inp}last name:{style.default} ")
        player_lastname = input()

        delay.print_delay(f"Please enter your fighter's {style.inp}nickname:{style.default} ")
        player_alias = input()
        ...
        delay.print_pause(f"{style.inp}[2]{style.defb} Defensive{style.default} - Your fighter will take less damage on successful blocks")
        delay.print_pause(f"{style.inp}[3]{style.defb} Tanky{style.default} - Your fighter has a higher health pool\n")
...
def character_details():
    try:
        ...
        print(f"{style.err}You have not created a fighter yet! Please create a new fighter from the main menu")
