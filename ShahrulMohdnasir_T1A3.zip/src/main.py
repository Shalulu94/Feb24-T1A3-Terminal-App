...
delay.print_delay(
    f"{style.default}Welcome to {style.b_und}Fight Night!{style.default}\n"
)
time.sleep(0.75)
delay.print_delay(
    ...
    while user_input != 4:
        try:
            ...
            if user_input == 1:
                ...
                print(
                    f"{style.err}That is an invalid selection. Please enter a number between 1 and 4"
                )

        except ValueError:
            print(
                f"{style.err}That's an invalid selection. Please enter a number between 1 and 4\n"
            )
