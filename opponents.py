...
def opponent():
    ...
    while character_creation.player.battle_won < 4:
        if character_creation.player.battle_won == 0:
            ...
            delay.print_delay(f"{style.default}Your next opponent will be {jager.opp_full_name}!\n")
            time.sleep(0.75)
            ...
            delay.print_delay(f"{style.default}Your next opponent will be {johnny.opp_full_name}!\n")
            time.sleep(0.75)
            ...
            delay.print_delay(f"{style.default}Your next opponent will be {pimmsy.opp_full_name}!\n")
            time.sleep(0.75)
            ...
            delay.print_delay(f"{style.default}You've defeated all the opponents and have been crowned {style.defbu}World Champion!{style.default}\n")
            delay.print_delay("\nGame over!")
