    ...
    try:
        ...
        while user_input != 5:
            ...
            if character_creation.player.battle_won == 3:
                ...
                delay.print_delay(
                    f"{style.default}Congratulation's you've defeated all of the opponent's and are crowned {style.defbu}World Champion!!\n"
                )
                delay.print_delay(
            ...
            delay.print_delay(
                f"{style.default}Welcome to the locker room {character_creation.player.first_name}!\n"
            )
            delay.print_delay(
            ...
            if user_input == 1:
                ...
                print(
                    f"{style.err}That is an invalid selection. Please enter a number between 1 and 3{style.default}"
                )
